// ================================================================
// SYSTÈME D'AUTHENTIFICATION OAUTH2 POUR TON SITE
// Ajoute ce fichier dans /src/auth.js
// ================================================================
...
const DISCORD_CLIENT_ID = process.env.CLIENT_ID; // Tu l'as déjà dans ton .env !
const DISCORD_CLIENT_SECRET = process.env.DISCORD_CLIENT_SECRET; // À ajouter
const DISCORD_REDIRECT_URI = process.env.DISCORD_REDIRECT_URI || 'http://localhost:3000/callback';
const DISCORD_GUILD_ID = process.env.GUILD_ID; // Tu l'as déjà !
const FRONTEND_URL = process.env.FRONTEND_URL || 'http://localhost:8080';
const SESSION_SECRET = process.env.SESSION_SECRET || 'zyngaaa-secret-change-me';
...
function startAuthServer() {
    app.listen(AUTH_PORT, () => {
        console.log(`🔐 Serveur d'authentification sur le port ${AUTH_PORT}`);
        console.log(`📍 Callback: ${DISCORD_REDIRECT_URI}`);
